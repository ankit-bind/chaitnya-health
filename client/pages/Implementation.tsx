  ...
  const implementationTeam = [
    {
      ...
      description:
        "Your dedicated point of contact for the entire implementation",
      responsibilities: [
    ...
    },
    {
      ...
      description:
        "Expert responsible for technical integration and customization",
      responsibilities: [
        "System architecture",
        "Integration design",
        "Technical reviews",
    ...
    },
    {
      ...
      description:
        "Ensures your team is fully trained and confident using the platform",
      responsibilities: [
    ...
    },
    {
      ...
      description:
        "Provides ongoing technical support throughout implementation",
      responsibilities: [
        ...
        <div className="space-y-12">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our expert implementation team ensures a smooth, efficient rollout
              of your mental wellness platform with minimal disruption to your
              operations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-primary/20 bg-white/90 backdrop-blur-sm text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Structured implementation process from planning to
                  optimization
                </CardDescription>
              </CardHeader>
            </Card>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Six-phase approach ensuring successful platform deployment
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {implementationPhases.map((phase) => (
                <Button
                  key={phase.phase}
                  variant={
                    selectedPhase === phase.phase ? "default" : "outline"
                  }
                  size="sm"
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Dedicated experts ensuring your success
              </p>
            </div>
          ...
          <Card className="border-2 border-primary/20 bg-white/90 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription className="text-center">
                How we measure implementation success
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="bg-gradient-to-r from-wisdom/10 to-primary/10 rounded-2xl p-8 text-center border border-wisdom/30">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Our implementation experts are ready to help you deploy your
              mental wellness platform successfully. Get started with a detailed
              planning session.
            </p>
