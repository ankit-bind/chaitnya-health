  ...
  const partnerNGOs = [
    {
      ...
      description:
        "Leading organization providing mental health awareness and support across India",
      location: "Pan India",
    ...
    },
    {
      ...
      description:
        "Focused on providing mental health support specifically for adolescents and young adults",
    ...
    },
    {
      ...
      description:
        "Grassroots organization working in rural and urban slums to provide mental health access",
  ...
  const integrationFeatures = [
    {
      ...
      description:
        "Secure, HIPAA-compliant data sharing between Chaitnya Health platform and NGO systems",
      icon: Globe,
    ...
    },
    {
      ...
      description:
        "Collaborative training for NGO counselors using our AI-powered training modules",
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        "Real-time analytics to measure and improve mental health outcomes in communities",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "AI-powered resource allocation to maximize impact and reach underserved populations",
      icon: Target,
        ...
        <div className="space-y-12">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Partnering with NGOs across India to democratize mental health
              support and create lasting community impact through technology and
              collaboration.
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Seamless technology integration to amplify NGO impact
              </p>
            </div>
              ...
              {integrationFeatures.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    <CardHeader>
                      <div
                        className={`w-12 h-12 bg-gradient-to-br ${feature.color}/20 rounded-lg flex items-center justify-center mb-4`}
                      >
                        <IconComponent
          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">
                  Verified organizations making a difference in mental health
                </p>
              </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                How NGO Integration Works
              </h2>
              <p className="text-muted-foreground">
                Simple steps to integrate and amplify your organization's impact
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Submit your NGO details and get verified by our team
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Seamless integration of your systems with our platform
                </p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Leverage AI and analytics to maximize your community impact
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-wisdom/10 to-primary/10 rounded-2xl p-8 text-center border border-wisdom/30">
            <h2 className="text-2xl font-bold text-foreground mb-4">
              Ready to Join Our NGO Network?
            </h2>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Become part of India's largest mental health NGO network.
              Together, we can democratize mental wellness and create lasting
