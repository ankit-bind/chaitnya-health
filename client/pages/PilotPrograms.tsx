  ...
  const successStories = [
    {
      ...
      duration: "6 months",
      results: ["40% reduction in reported anxiety", "60% increase in help-seeking behavior", "90% student satisfaction"],
      quote: "Chaitnya Health transformed how we approach student mental wellness. The AI companions provided 24/7 support that our counseling center couldn't match."
    },
    {
      ...
      duration: "3 months",
      results: ["25% improvement in work-life balance scores", "50% increase in mental health awareness", "35% reduction in sick leaves"],
      quote: "Our employees love the convenience of having mental health support available anytime. The impact on productivity and wellbeing has been remarkable."
    }
  ];
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground -mt-1">Pilot Programs</p>
              </div>
            </div>
        ...
        <div className="space-y-12">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Start your mental wellness transformation journey with our carefully designed pilot programs. Test, measure, and scale at your own pace.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-2 border-primary/20 bg-white/90 backdrop-blur-sm text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Demonstrate measurable impact on mental wellness metrics before full-scale implementation
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 border-trust/20 bg-white/90 backdrop-blur-sm text-center">
              <CardHeader>
                ...
                <CardDescription>
                  Get started in days, not months. Minimal IT requirements and seamless integration
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-2 border-support/20 bg-white/90 backdrop-blur-sm text-center">
              <CardHeader>
                ...
                <CardDescription>
                  No long-term commitments. Test our platform with confidence and scale when ready
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-foreground mb-4">Choose Your Pilot Program</h2>
              <p className="text-muted-foreground">Tailored programs for different institution sizes and needs</p>
            </div>
              ...
              {pilotPrograms.map((program) => (
                ...
                >
                  <CardHeader className="text-center">
                    <div className={`w-16 h-16 bg-gradient-to-br ${program.color}/20 rounded-xl flex items-center justify-center mx-auto mb-4`}>
                      <Rocket className={`h-8 w-8 bg-gradient-to-r ${program.color} bg-clip-text text-transparent`} />
                    </div>
                    <CardTitle className="text-2xl">{program.name}</CardTitle>
                    <div className="text-3xl font-bold text-foreground">{program.price}</div>
                    <CardDescription className="text-base">{program.ideal}</CardDescription>
                  </CardHeader>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-foreground mb-4">Pilot Program Success Stories</h2>
              <p className="text-muted-foreground">Real results from institutions that started with our pilot programs</p>
            </div>
                ...
                <Card key={index} className="border-2 border-primary/20 bg-white/90 backdrop-blur-sm">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        <CardTitle className="text-xl">{story.institution}</CardTitle>
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-foreground mb-4">Pilot Program Timeline</h2>
              <p className="text-muted-foreground">What to expect during your pilot journey</p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Week 1-2: Platform configuration, team training, and initial user registration</p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Week 3-8: User engagement campaigns, initial data collection, and feedback gathering</p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Week 9-12: Platform optimization, advanced feature rollout, and impact measurement</p>
              </div>
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Final month: Impact analysis, ROI calculation, and scaling recommendations</p>
              </div>
            </div>
          </div>
          ...
          <Card className="border-2 border-primary/20 bg-white/90 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl text-center">What's Included in Every Pilot Program</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { icon: BookOpen, title: "Training & Onboarding", desc: "Comprehensive training for your team and users" },
                  { icon: BarChart3, title: "Analytics Dashboard", desc: "Real-time insights and progress tracking" },
                  { icon: Users, title: "Dedicated Support", desc: "Expert guidance throughout your pilot journey" },
                  { icon: Shield, title: "Data Security", desc: "HIPAA-compliant data protection and privacy" },
                  { icon: Target, title: "Success Metrics", desc: "Clear KPIs and ROI measurement framework" },
                  { icon: Award, title: "Best Practices", desc: "Proven strategies for successful implementation" }
                ].map((item, index) => {
          ...
          <div className="bg-gradient-to-r from-wisdom/10 to-primary/10 rounded-2xl p-8 text-center border border-wisdom/30">
            <h2 className="text-2xl font-bold text-foreground mb-4">Ready to Start Your Pilot Program?</h2>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Take the first step towards transforming mental wellness at your institution. Our pilot programs are designed for success with minimal risk.
            </p>
